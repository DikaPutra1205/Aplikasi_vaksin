<?php
include 'koneksi.php';
include 'data_user_controller.php';
?>
...
<head>
    ...
    <title>Aplikasi Vaksin - Data Pengguna</title>
...
<div class="container">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <a class="navbar-brand" href="data_user.php">Daftar User</a>
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a href="tambah_user.php" class="btn btn-primary me-2">Tambah User</a>
                    </li>
                    <li class="nav-item">
    ...
    <h2 class="text-center mt-4">Data Pengguna</h2>
        ...
        <tbody>
            <?php while ($row = $result->fetch_assoc()) { ?>
                <tr>
                    ...
                    <td>
                        <a href="edit_user.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm me-2">Edit</a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="hapus_user.php?id=<?php echo $row['id']; ?>" type="button" class="btn btn-danger">Hapus</a>
                                    </div>
                                </div>
                            </div>
                        </div>
